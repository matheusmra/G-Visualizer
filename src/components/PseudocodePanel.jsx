...
export default function PseudocodePanel({ algorithm, algoState }) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="rounded-lg p-3 bg-gray-100 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700/50 text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
        {pseudo.description}
      </div>
      ...
      <div className="rounded-lg bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700/50 overflow-hidden">
        <div className="flex items-center justify-between px-3 py-1.5 bg-gray-100 dark:bg-gray-800/80 border-b border-gray-200 dark:border-gray-700/50">
          <span className="text-xs font-mono text-gray-500 dark:text-gray-400">pseudocódigo</span>
          {!algoState && (
            <span className="text-[10px] text-gray-400 dark:text-gray-600 italic">Inicie o algoritmo para ver o destaque</span>
          )}
        </div>
        ...
        <div className="py-2 overflow-x-auto">
          {pseudo.lines.map((line, i) => {
            ...
            return (
              ...
              >
                <span className="w-5 text-right shrink-0 text-gray-400 dark:text-gray-600 select-none font-mono text-xs">
                  {lineNum}
                </span>
